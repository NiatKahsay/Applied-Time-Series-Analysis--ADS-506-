...
```{r}
# Create a model function that contains the best candidates for forecasting and Baseline model
...
cv_metrics_12 <- ili_cv_fc_12 |>
  ...
  tab_header(
    title = "Cross-Validation Forecast Accuracy (5-Year Rolling Origin, 12-Week Horizon)",
...
gt_cv_metrics_52 <- cv_metrics_52 |>
  ...
  fmt_number(columns = c(RMSE, MAE, MAPE), decimals = 1) |>
  tab_header(
    title = "Cross-Validation Forecast Accuracy (5-Year Rolling Origin, 52-Week Horizon)",
    subtitle = "ILI Net, Training up to 2025"
  )
